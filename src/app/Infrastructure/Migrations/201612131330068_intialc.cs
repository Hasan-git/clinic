namespace Clinic.Infrastructure.Migrations
{
    ...
    public partial class intialc : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ConsultaionId = c.Guid(nullable: false),
                        FollowUpId = c.Guid(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Consultation", t => t.ConsultaionId)
                .ForeignKey("dbo.FollowUp", t => t.FollowUpId)
                .Index(t => t.ConsultaionId)
                .Index(t => t.FollowUpId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Images", "FollowUpId", "dbo.FollowUp");
            DropForeignKey("dbo.Images", "ConsultaionId", "dbo.Consultation");
