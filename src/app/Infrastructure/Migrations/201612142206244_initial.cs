namespace Clinic.Infrastructure.Migrations
{
    ...
    public partial class initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        FollowUp_Id = c.Guid(),
                        Consultation_Id = c.Guid(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.FollowUp", t => t.FollowUp_Id)
                .ForeignKey("dbo.Consultation", t => t.Consultation_Id)
                .Index(t => t.FollowUp_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Images", "Consultation_Id", "dbo.Consultation");
            DropForeignKey("dbo.Images", "FollowUp_Id", "dbo.FollowUp");
